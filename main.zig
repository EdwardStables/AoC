...
fn get_tasks(comptime year: u32, comptime day: u32) TaskPair {
    const file = switch (year) {
        2019 => switch (day) {
            ...
            3 => @import("year_2019/day_03/task.zig"),
            4 => @import("year_2019/day_04/task.zig"),
            5 => @import("year_2019/day_05/task.zig"),
            6 => @import("year_2019/day_06/task.zig"),
            7 => @import("year_2019/day_07/task.zig"),
            8 => @import("year_2019/day_08/task.zig"),
            9 => @import("year_2019/day_09/task.zig"),
            10 => @import("year_2019/day_10/task.zig"),
            11 => @import("year_2019/day_11/task.zig"),
            12 => @import("year_2019/day_12/task.zig"),
        ...
        2024 => switch (day) {
            ...
            21 => @import("year_2024/day_21/task.zig"),
        ...
        2025 => switch (day) {
            ...
            2  => @import("year_2025/day_02/task.zig"),
            3  => @import("year_2025/day_03/task.zig"),
            4  => @import("year_2025/day_04/task.zig"),
            5  => @import("year_2025/day_05/task.zig"),
            6  => @import("year_2025/day_06/task.zig"),
            7  => @import("year_2025/day_07/task.zig"),
            8  => @import("year_2025/day_08/task.zig"),
            9  => @import("year_2025/day_09/task.zig"),
            10 => @import("year_2025/day_10/task.zig"),
            11 => @import("year_2025/day_11/task.zig"),
            12 => @import("year_2025/day_12/task.zig"),
            else => @compileError("Unknown day defined.")
        },
...
const RunResult = struct { value: i64, time: f32 };
